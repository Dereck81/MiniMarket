...
import {Box, TextField, Button, Typography, Modal, Avatar, Grid, FormHelperText, FormControl} from '@mui/material';
            ...
            <Modal open={openModal} onClose={handleCloseModal}>
                <Box sx={modalStyle}>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <FormControl fullWidth error={dniError}>
                                <TextField
                                    label="DNI"
                                    variant="outlined"
                                    value={dni}
                                ...
                                />
                                {dniError && (
                                    <FormHelperText>El DNI debe tener 8 dígitos</FormHelperText>
                                )}
                            </FormControl>
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <FormControl fullWidth error={telefonoError}>
                                <TextField
                                    label="Teléfono"
                                    variant="outlined"
                                    value={telefono}
                                ...
                                />
                                {telefonoError && (
                                    <FormHelperText>El teléfono debe tener 9 dígitos</FormHelperText>
                                )}
                            </FormControl>
                        </Grid>
